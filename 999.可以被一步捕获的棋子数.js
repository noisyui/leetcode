...
var numRookCaptures = function(board) {
    ...
    for (let i = 0; i < 8 && !posR; i++) {
        for (let j = 0; j < 8 && !posR; j++) {
            let chess = board[i][j];
            if (chess === 'R') {
                posR = [i, j];
            }
    ...
    let i = posR[0], j = posR[1];
    let result = 0;
    for (let pos = i + 1; pos < 8; pos++) {
        if (board[pos][j] === 'B') break;
        if (board[pos][j] === 'p') {
            result++;
            break;
        }
    ...
    for (let pos = j + 1; pos < 8; pos++) {
        if (board[i][pos] === 'B') break;
        if (board[i][pos] === 'p') {
            result++;
            break;
        }
